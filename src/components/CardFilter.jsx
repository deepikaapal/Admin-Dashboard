    ...
    return (
        <div className="filter dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <li>
                    <a className="dropdown-item" onClick={() => handleDate('Today')}>
                        Today
                    </a>
                </li>
                <li>
                    <a className="dropdown-item" onClick={() => handleDate('This Month')}>
                        This Month
                    </a>
                </li>
                <li>
                    <a className="dropdown-item" onClick={() => handleDate('This Year')}>
                        This Year
                    </a>
                </li>
